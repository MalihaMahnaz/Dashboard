       ...
       <div className="pt-[25px] px-[25px] bg-[#F8F9FC]">
           <div className="flex items-center justify-between">
            ...
            <div className="grid grid-cols-4 gap-[30px] mt-[25px] pb-[15px]">
                <div className="h-[100px] rounded-[8px] bg-white border-l-[4px] border-[#4E73DF] flex items-center justify-between px-[30px] cursor-pointer hover:shadow-lg transform hover:scale-[103%] transitio duration-300 ease-out">
                    <div>
            ...
            <div className="flex mt-[22px] w-full gap-[30px]">
                    <div className="basis-[55%] border bg-white shadow-md cursor-pointer rounded-[4px]">
                      ...
                      <div className="px-[25px] space-y-[15px] py-[15px]">
                        ...
                        <div>
                          ...
                          <Progress percent={50} strokeColor="#F6C23E" status="active"/>
                        </div>
                        <div>
                          <h2>Customer Database</h2>
                          <Progress percent={70} strokeColor="#4E73DF" status="active"/>
                        </div>
                        <div>
                          <h2>Payout Details</h2>
                          <Progress percent={100} strokeColor="#36B9CC" status="active"/>
                        </div>
                        <div>
                          <h2>Account Setup</h2>
                          <Progress percent={50} strokeColor="#1CC88A" status="exception"/>
                        </div>
                    ...
                    <div className="basis-[45%] border bg-white cursor-pointer shadow-md rounded-[4px]">
                      ...
                      <div className="pl-[35px] flex items-center justify-center h-[100%]">
                        <div>
                          <img src={err} alt="" width={55} height={55}/>
